            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">Scholarship Policy</h2>
                  <a
                    href="/images/Scholarship-Policy.pdf"
                    download
                ...
                <div className="w-full border border-gray-200 rounded-lg overflow-hidden bg-gray-50">
                  <iframe
                    src="/images/Scholarship-Policy.pdf"
                    className="w-full h-[600px] md:h-[700px] lg:h-[800px]"
                    title="Scholarship Policy PDF"
                  />
                </div>
