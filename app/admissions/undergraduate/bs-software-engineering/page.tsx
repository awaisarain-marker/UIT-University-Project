...
export default function BSSoftwareEngineeringPage() {
  const [activeTab, setActiveTab] = useState('overview');

  const computingPrograms = [
    { name: 'BS Computer Science', href: '/admissions/undergraduate/bs-computer-science', active: false },
    { name: 'BS Software Engineering', href: '/admissions/undergraduate/bs-software-engineering', active: true },
    { name: 'BS Artificial Intelligence', href: '/admissions/undergraduate/bs-artificial-intelligence', active: false },
          ...
          <main className="flex-1">
            ...
            <Card className="mb-8">
              <CardContent className="p-0">
                <div className="bg-gradient-to-r from-orange-600 to-red-700 h-64 flex items-center justify-center">
                  <div className="text-center text-white">
                    <h2 className="text-3xl font-bold mb-2">BS Software Engineering</h2>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            <tr><td className="border border-gray-300 py-2 px-4">CSC103</td><td className="border border-gray-300 py-2 px-4">Object Oriented Programming</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">1</td><td className="border border-gray-300 py-2 px-4 text-center">4</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSC108</td><td className="border border-gray-300 py-2 px-4">Discrete Structures</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSC111</td><td className="border border-gray-300 py-2 px-4">Digital Logic Design</td><td className="border border-gray-300 py-2 px-4 text-center">2</td><td className="border border-gray-300 py-2 px-4 text-center">1</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">ASC111</td><td className="border border-gray-300 py-2 px-4">Calculus & Analytical Geometry</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">HSC111</td><td className="border border-gray-300 py-2 px-4">English Composition & Comprehension</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">HSC105</td><td className="border border-gray-300 py-2 px-4">Pakistan Studies</td><td className="border border-gray-300 py-2 px-4 text-center">2</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">2</td></tr>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            <tr><td className="border border-gray-300 py-2 px-4">CSC303</td><td className="border border-gray-300 py-2 px-4">Computer Organization & Assembly Language</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">1</td><td className="border border-gray-300 py-2 px-4 text-center">4</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSC301</td><td className="border border-gray-300 py-2 px-4">Design and Analysis of Algorithms</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSE202</td><td className="border border-gray-300 py-2 px-4">Software Requirements Engineering</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">ASC202</td><td className="border border-gray-300 py-2 px-4">Multivariate Calculus</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSC304</td><td className="border border-gray-300 py-2 px-4">Artificial Intelligence</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">HSC110</td><td className="border border-gray-300 py-2 px-4">Civics & Community Engagement</td><td className="border border-gray-300 py-2 px-4 text-center">2</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">2</td></tr>
                            <tr className="bg-gray-50 font-semibold"><td colSpan={4} className="border border-gray-300 py-2 px-4 text-right">Total</td><td className="border border-gray-300 py-2 px-4 text-center">18</td></tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            <tr><td className="border border-gray-300 py-2 px-4">CNS301</td><td className="border border-gray-300 py-2 px-4">Computer Networks</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">1</td><td className="border border-gray-300 py-2 px-4 text-center">4</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSE203</td><td className="border border-gray-300 py-2 px-4">Software Design & Architecture</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">1</td><td className="border border-gray-300 py-2 px-4 text-center">4</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSC203</td><td className="border border-gray-300 py-2 px-4">Operating Systems</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">1</td><td className="border border-gray-300 py-2 px-4 text-center">4</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">ASC201</td><td className="border border-gray-300 py-2 px-4">Probability & Statistics</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">Domain Elective – I</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr className="bg-gray-50 font-semibold"><td colSpan={4} className="border border-gray-300 py-2 px-4 text-right">Total</td><td className="border border-gray-300 py-2 px-4 text-center">18</td></tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            <tr><td className="border border-gray-300 py-2 px-4">CSE301</td><td className="border border-gray-300 py-2 px-4">Software Construction & Development</td><td className="border border-gray-300 py-2 px-4 text-center">2</td><td className="border border-gray-300 py-2 px-4 text-center">1</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CNS302</td><td className="border border-gray-300 py-2 px-4">Information Security</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">MSC203</td><td className="border border-gray-300 py-2 px-4">Principles of Management</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSE401</td><td className="border border-gray-300 py-2 px-4">Parallel & Distributed Computing</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSE304</td><td className="border border-gray-300 py-2 px-4">Software Project Management</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">Domain Elective – II</td><td className="border border-gray-300 py-2 px-4 text-center">2</td><td className="border border-gray-300 py-2 px-4 text-center">1</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr className="bg-gray-50 font-semibold"><td colSpan={4} className="border border-gray-300 py-2 px-4 text-right">Total</td><td className="border border-gray-300 py-2 px-4 text-center">18</td></tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            <tr><td className="border border-gray-300 py-2 px-4">CSE303</td><td className="border border-gray-300 py-2 px-4">Software Quality Engineering</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">MSC301</td><td className="border border-gray-300 py-2 px-4">Technopreneurship</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">Domain Elective – III</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">Domain Elective – IV</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">Domain Elective – V</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSE496</td><td className="border border-gray-300 py-2 px-4">Capstone Project – I</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr className="bg-gray-50 font-semibold"><td colSpan={4} className="border border-gray-300 py-2 px-4 text-right">Total</td><td className="border border-gray-300 py-2 px-4 text-center">18</td></tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            <tr><td className="border border-gray-300 py-2 px-4">HSC311</td><td className="border border-gray-300 py-2 px-4">Computing Professional Practices</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">MSC202</td><td className="border border-gray-300 py-2 px-4">Principles of Marketing</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">Domain Elective – VI</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSE497</td><td className="border border-gray-300 py-2 px-4">Capstone Project – II</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr className="bg-gray-50 font-semibold"><td colSpan={4} className="border border-gray-300 py-2 px-4 text-right">Total</td><td className="border border-gray-300 py-2 px-4 text-center">12</td></tr>
                          </tbody>
                        </table>
                      </div>
                    </CardContent>
                  ...
                  <Card className="bg-blue-50 border-blue-200">
                    <CardContent className="p-6">
                      <p className="text-gray-900 font-semibold">
                        <span className="text-primary">Note:</span> Internship after 4th Semester (0-3-3)
                      </p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div className="space-y-8">
                  <Card>
                    <CardContent className="p-8">
                      ...
                      <p className="text-gray-700 mb-4">The graduates of the BS Software Engineering program will have the knowledge, understanding and skills to:</p>
                      <ul className="space-y-3">
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">Pursue diverse range of careers, advanced degrees or professional development in software engineering or other multidisciplinary areas.</span>
                        </li>
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">Apply software engineering principles and modern practices to design innovative and sustainable solutions for challenging problems faced by businesses and the society at large.</span>
                        </li>
                        <li className="flex items-start gap-3">
                  ...
                  <Card>
                    <CardContent className="p-8">
                      ...
                      <p className="text-gray-700 mb-4">The students of BS Software Engineering program are expected to attain the following outcomes by the time of graduation:</p>
