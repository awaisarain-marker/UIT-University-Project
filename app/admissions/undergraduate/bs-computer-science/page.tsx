...
export default function BSComputerSciencePage() {
  const [activeTab, setActiveTab] = useState('overview');

  const computingPrograms = [
    { name: 'BS Computer Science', href: '/admissions/undergraduate/bs-computer-science', active: true },
          ...
          <main className="flex-1">
            ...
            <Card className="mb-8">
              <CardContent className="p-0">
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 h-64 flex items-center justify-center">
                  <div className="text-center text-white">
                    <h2 className="text-3xl font-bold mb-2">BS Computer Science</h2>
                        ...
                        <table className="w-full border-collapse">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td className="py-3 px-4 text-gray-700">45 (Including Final Year Project)</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            ...
                            <tr><td className="border border-gray-300 py-2 px-4">CSC206</td><td className="border border-gray-300 py-2 px-4">Computer Architecture</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CIC201</td><td className="border border-gray-300 py-2 px-4">Artificial Intelligence</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            ...
                            <tr><td className="border border-gray-300 py-2 px-4">CSC205</td><td className="border border-gray-300 py-2 px-4">Theory of Automata</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            ...
                            <tr><td className="border border-gray-300 py-2 px-4">CSC304</td><td className="border border-gray-300 py-2 px-4">Advanced Database Management Systems</td><td className="border border-gray-300 py-2 px-4 text-center">2</td><td className="border border-gray-300 py-2 px-4 text-center">1</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            ...
                            <tr><td className="border border-gray-300 py-2 px-4">CSC302</td><td className="border border-gray-300 py-2 px-4">Parallel & Distributed Computing</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CNS302</td><td className="border border-gray-300 py-2 px-4">Information Security</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSE204</td><td className="border border-gray-300 py-2 px-4">Human Computer Interaction</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            <tr><td className="border border-gray-300 py-2 px-4">CSC303</td><td className="border border-gray-300 py-2 px-4">Compiler Construction</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            ...
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">Domain Elective – VII</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CSC497</td><td className="border border-gray-300 py-2 px-4">Capstone Project – II</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr className="bg-gray-50 font-semibold"><td colSpan={4} className="border border-gray-300 py-2 px-4 text-right">Total</td><td className="border border-gray-300 py-2 px-4 text-center">15</td></tr>
                          </tbody>
                        </table>
                      </div>
                ...
                <div className="space-y-8">
                  <Card>
                    <CardContent className="p-8">
                      ...
                      <p className="text-gray-700 mb-4">The graduates of the BS Computer Science program will have the knowledge, understanding and skills to:</p>
                      <ul className="space-y-3">
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">Pursue diverse range of careers, advanced degrees, or professional development in various computing disciplines.</span>
                        </li>
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">Apply analytical skills, computing principles, and modern technologies to design innovative and sustainable computing solutions to meet business objectives and societal challenges.</span>
                        </li>
                        <li className="flex items-start gap-3">
                  ...
                  <Card>
                    <CardContent className="p-8">
                      ...
                      <p className="text-gray-700 mb-4">The students of BS Computer Science program are expected to attain the following outcomes by the time of graduation:</p>
