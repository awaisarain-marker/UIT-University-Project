...
export default function BSDataSciencePage() {
  ...
  const computingPrograms = [
    ...
    { name: 'BS Data Science', href: '/admissions/undergraduate/bs-data-science', active: true }
  ];
          ...
          <main className="flex-1">
            ...
            <Card className="mb-8">
              <CardContent className="p-0">
                <div className="bg-gradient-to-r from-green-600 to-teal-700 h-64 flex items-center justify-center">
                  <div className="text-center text-white">
                    <h2 className="text-3xl font-bold mb-2">BS Data Science</h2>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            ...
                            <tr><td className="border border-gray-300 py-2 px-4">CDS-201</td><td className="border border-gray-300 py-2 px-4">Introduction to Data Science</td><td className="border border-gray-300 py-2 px-4 text-center">2</td><td className="border border-gray-300 py-2 px-4 text-center">1</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            ...
                            <tr><td className="border border-gray-300 py-2 px-4">CDS-301</td><td className="border border-gray-300 py-2 px-4">Data Visualization</td><td className="border border-gray-300 py-2 px-4 text-center">2</td><td className="border border-gray-300 py-2 px-4 text-center">1</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            ...
                            <tr><td className="border border-gray-300 py-2 px-4">CDS-303</td><td className="border border-gray-300 py-2 px-4">Data Mining</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">DS Domain Elective – I</td><td className="border border-gray-300 py-2 px-4 text-center">2/3</td><td className="border border-gray-300 py-2 px-4 text-center">1/0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">DS Domain Elective – II</td><td className="border border-gray-300 py-2 px-4 text-center">2/3</td><td className="border border-gray-300 py-2 px-4 text-center">1/0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr className="bg-gray-50 font-semibold"><td colSpan={4} className="border border-gray-300 py-2 px-4 text-right">Total</td><td className="border border-gray-300 py-2 px-4 text-center">18</td></tr>
                          </tbody>
                        </table>
                      </div>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            ...
                            <tr><td className="border border-gray-300 py-2 px-4">CDS-304</td><td className="border border-gray-300 py-2 px-4">Data Warehouse & Business Intelligence</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">DS Domain Elective – III</td><td className="border border-gray-300 py-2 px-4 text-center">2/3</td><td className="border border-gray-300 py-2 px-4 text-center">1/0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            ...
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">DS Domain Elective – IV</td><td className="border border-gray-300 py-2 px-4 text-center">2/3</td><td className="border border-gray-300 py-2 px-4 text-center">1/0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">DS Domain Elective – V</td><td className="border border-gray-300 py-2 px-4 text-center">2/3</td><td className="border border-gray-300 py-2 px-4 text-center">1/0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">MSC-203</td><td className="border border-gray-300 py-2 px-4">Principle of Management</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">CDS-302</td><td className="border border-gray-300 py-2 px-4">Advanced Statistics</td><td className="border border-gray-300 py-2 px-4 text-center">3</td><td className="border border-gray-300 py-2 px-4 text-center">0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                      ...
                      <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                          ...
                          <tbody>
                            ...
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">DS Domain Elective – VI</td><td className="border border-gray-300 py-2 px-4 text-center">2/3</td><td className="border border-gray-300 py-2 px-4 text-center">1/0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">DS Domain Elective – VII</td><td className="border border-gray-300 py-2 px-4 text-center">2/3</td><td className="border border-gray-300 py-2 px-4 text-center">1/0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                            <tr><td className="border border-gray-300 py-2 px-4">-</td><td className="border border-gray-300 py-2 px-4">DS Domain Elective – VIII</td><td className="border border-gray-300 py-2 px-4 text-center">2/3</td><td className="border border-gray-300 py-2 px-4 text-center">1/0</td><td className="border border-gray-300 py-2 px-4 text-center">3</td></tr>
                ...
                <div className="space-y-8">
                  <Card>
                    <CardContent className="p-8">
                      ...
                      <p className="text-gray-700 mb-4">The graduates of the BS Data Science program will have the knowledge, understanding and skills to:</p>
                      <ul className="space-y-3">
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">Pursue diverse range of careers, advanced degrees or professional development in computing and data science knowledge acquired during studies.</span>
                        </li>
                        <li className="flex items-start gap-3">
                          ...
                          <span className="text-gray-700">Apply data science principles and modern practices to design innovative solutions for challenging problems faced by businesses.</span>
                        </li>
                        <li className="flex items-start gap-3">
                  ...
                  <Card>
                    <CardContent className="p-8">
                      ...
                      <p className="text-gray-700 mb-4">The students of BS Data Science program are expected to attain the following outcomes by the time of graduation:</p>
